...
CREATE TABLE IF NOT EXISTS privateKeys  (userId TEXT PRIMARY KEY, encryptedprivkey TEXT NOT NULL, FOREIGN KEY(userId) REFERENCES users(userId) ON DELETE CASCADE );
